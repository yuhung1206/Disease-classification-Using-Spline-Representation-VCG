function [feature_spline, R_peak_num] = SplineFit_2_Lead_Exclude_NoSeg(signal, samplingrate, windowsize, DataNumber, typeString, ECG_data, lead_I)
...
feature_spline = [Spline_Vx Spline_Vy  TF' VF_Vx' VF_Vy' ]; % (X+Y), (X+Z) or (Y+Z)
